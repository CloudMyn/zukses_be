...
return new class extends Migration
{
    ...
    {
        Schema::create('tb_item_pesanan', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('id_produk')->nullable(); // Foreign key to tb_produk table
            ...
            $table->foreign('id_produk')->references('id')->on('tb_produk')->onDelete('set null');
    ...
    {
        Schema::dropIfExists('tb_item_pesanan');
    }
};
