...
class SystemSettingCreateRequest extends FormRequest
{
    ...
    {
        return [
            'nama_pengaturan' => 'required|string|max:255|unique:pengaturan_sistem,nama_pengaturan',
            'nilai_pengaturan' => 'required',
            'deskripsi_pengaturan' => 'required|string',
            'kategori_pengaturan' => 'required|in:GENERAL,PAYMENT,SHIPPING,EMAIL,SECURITY,SEO',
