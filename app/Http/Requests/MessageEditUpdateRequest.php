...
class MessageEditUpdateRequest extends FormRequest
{
    /**
    ...
    {
        $id = $this->route('messageEdit'); // Get the messageEdit ID from the route

        return [
            'id_pesan' => 'sometimes|required|exists:pesan_obrolan,id',
            'id_user' => 'sometimes|required|exists:users,id',
            'isi_pesan_lama' => 'sometimes|required|string',
            'isi_pesan_baru' => 'sometimes|required|string',
            'tanggal_edit' => 'sometimes|required|date',
        ];
    }
