...
class SellerUpdateRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        return $this->user()->tipe_user === 'ADMIN' || $this->user()->id === $seller->id_user;
    }
    ...
    public function rules(): array
    {
        ...
        return [
            'nama_toko' => ['required', 'string', 'max:255', Rule::unique('penjual')->ignore($sellerId)],
            'slug_toko' => ['required', 'string', 'max:255', Rule::unique('penjual')->ignore($sellerId)],
            ...
            'nomor_ktp' => ['required', 'string', 'max:16', Rule::unique('penjual')->ignore($sellerId)],
            'foto_ktp' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:2048',
            'nomor_npwp' => ['nullable', 'string', 'max:15', Rule::unique('penjual')->ignore($sellerId)],
