...
class OrderShippingCreateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'kode_pos_pengiriman' => 'required|string|max:20',
            'negara_pengiriman' => 'required|string|max:255',
            'kota_tujuan' => 'required|string|max:255',
            'provinsi_tujuan' => 'required|string|max:255',
            'kode_pos_tujuan' => 'required|string|max:20',
